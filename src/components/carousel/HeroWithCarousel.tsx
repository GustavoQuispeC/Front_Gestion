...
const CarouselDemo = () => {
  ...
  const images = [
    "https://firebasestorage.googleapis.com/v0/b/grupofamet-456604.firebasestorage.app/o/imagenes-ui%2Fcarousel%2F3361eea4-843d-4ad4-ae2e-3abead2762e9.jpg?alt=media&token=fc63b7a1-e1fe-4db7-8876-7a5f6508e7ee",
