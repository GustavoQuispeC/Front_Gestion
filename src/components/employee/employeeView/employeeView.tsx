...
const EmployeeView = ({ employeeId }: { employeeId: string }) => {
  ...
  return (
    <div className="min-h-screen py-10 px-6 flex items-center justify-center bg-white text-black dark:bg-black dark:text-white">
      <div className="w-full max-w-6xl bg-neutral-50 dark:bg-neutral-900 p-8 rounded-xl shadow-lg">
        <div className="flex justify-between mb-8">
          <h1 className="text-3xl text-blue-900 dark:text-blue-500 font-bold">
            Detalles del Empleado
          </h1>
          <Button
            onClick={() => router.push("/dashboard/employeeList")}
            className="flex items-center gap-2 w-64 bg-gray-200"
            variant="outline"
          >
            <IoMdArrowRoundBack />
            Volver
