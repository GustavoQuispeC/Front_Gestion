...
const OtrosGastos = () => {
  ...
  const [otrosGastos, setOtrosGastos] = useState<ListarGastoContableProps[]>(
    []
  );
  ...
  const [gastoContableRegistrar, setGastoContableRegistrar] =
    useState<GastoContableRegistrarProps>({
      ...
      usuario: "",
      proveedorId: "",
      gastoId: "3", //? valor por defecto (Otros Gastos)
    });
  ...
  const getOtrosGastos = useCallback(async () => {
    ...
    <>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex flex-wrap justify-end gap-3 w-full md:w-auto">
            ...
            <Button
              ...
              variant="outline"
              className="w-full md:w-auto"
              onClick={() => handleExportExcel(otrosGastos)}
            >
      ...
      <div className="overflow-x-auto bg-white shadow-lg rounded-lg p-4 mt-6 dark:bg-neutral-900 border">
        <Table className="w-full">
          <TableCaption>Listado de Otros Gastos</TableCaption>
          <TableHeader>
            <TableRow>
